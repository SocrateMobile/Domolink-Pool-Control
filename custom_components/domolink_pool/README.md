# DomoLink Pool Control pour Home Assistant

![Version](https://img.shields.io/badge/version-5.7.5-blue)
![HACS](https://img.shields.io/badge/HACS-Custom-orange)

Cette intégration non officielle pour Home Assistant permet de connecter votre analyseur d'eau **DomoLink Pool Control** et (optionnellement) votre **DomoLink Pool Control Hub**.

Contrairement aux autres intégrations, celle-ci offre une architecture **Hybride**. Elle se connecte à la fois à l'API Cloud de DomoLink Pool Control (pour récupérer les algorithmes de LSI, de chlore actif et l'historique) ET écoute en direct votre antenne Bluetooth locale. Dès que vous passez à côté de la piscine avec votre téléphone (ce qui déclenche le Bluetooth du DomoLink Pool Control), Home Assistant capte la mesure immédiatement, sans attendre la prochaine synchronisation cloud de votre abonnement (souvent limitée à 1 ou 2 fois par jour sans abonnement premium) !
...
5. Cliquez sur Ajouter, puis recherchez "DomoLink Pool Control Pool" dans HACS et cliquez sur Télécharger.
...
3. Cherchez **DomoLink Pool Control Pool**.
